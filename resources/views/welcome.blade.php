...
<section id="project-version-one" class="our-projects " style="background:url(http://profesionales5estrellas.com/wp-content/uploads/2016/01/bg-1.jpg) repeat scroll !important"><div class="container">
  <div class="section-title">
    <h1>Nuestros proyectos</h1>
  </div><div class="row normal-gallery" id="no-filter">
        <a href="http://profesionales5estrellas.com/" class="fancybox">
        <div class="col-lg-4 col-sm-6 col-xs-12 commercial residential  bathroom-plumbing broken-toilets single-project-item mix">
          <div class="img-wrap">
            <img src="http://profesionales5estrellas.com/" alt="">
            <div class="content-wrap hvr-rectangle-out">
              <div class="border">
                <div class="content">
                  <h4>Our Project 1</h4>
                  <span class="catname">Bathroom Plumbing</span>
                  <span class="catslug"> ( residential ) </span>
                </div>
              </div>
            </div>
          </div>
        ...
        <a href="http://profesionales5estrellas.com/" class="fancybox">
        <div class="col-lg-4 col-sm-6 col-xs-12 commercial  drane-cloge kitchen-plumbing single-project-item mix">
          <div class="img-wrap">
            <img src="http://profesionales5estrellas.com/" alt="">
            <div class="content-wrap hvr-rectangle-out">
              <div class="border">
                <div class="content">
                  <h4>Our Project 2</h4>
                  <span class="catname">Drane Cloge</span>
                  <span class="catslug"> ( commercial ) </span>
                </div>
              </div>
            </div>
          </div>
        ...
        <a href="http://profesionales5estrellas.com/" class="fancybox">
        <div class="col-lg-4 col-sm-6 col-xs-12 commercial leakage-prevention  drane-cloge kitchen-plumbing outside-plumbing single-project-item mix">
          <div class="img-wrap">
            <img src="http://profesionales5estrellas.com/" alt="">
            <div class="content-wrap hvr-rectangle-out">
              <div class="border">
                <div class="content">
                  <h4>Our Project 3</h4>
                  <span class="catname">Drane Cloge</span>
                  <span class="catslug"> ( leakage-prevention ) </span>
                </div>
              </div>
            </div>
          </div>
        ...
        <a href="http://profesionales5estrellas.com/" class="fancybox">
        <div class="col-lg-4 col-sm-6 col-xs-12 leakage-prevention  kitchen-plumbing outside-plumbing pipe-fixing single-project-item mix">
          <div class="img-wrap">
            <img src="http://profesionales5estrellas.com/" alt="">
            <div class="content-wrap hvr-rectangle-out">
              <div class="border">
                <div class="content">
                  <h4>Our Project 4</h4>
                  <span class="catname">Kitchen Plumbing</span>
                  <span class="catslug"> ( leakage-prevention ) </span>
                </div>
              </div>
            </div>
        ...
        <a href="http://profesionales5estrellas.com/" class="fancybox">
        <div class="col-lg-4 col-sm-6 col-xs-12 leakage-prevention plumbing-service  bathroom-plumbing broken-toilets drane-cloge single-project-item mix">
          <div class="img-wrap">
            <img src="http://profesionales5estrellas.com/" alt="">
            <div class="content-wrap hvr-rectangle-out">
              <div class="border">
                <div class="content">
                  <h4>Our Project 5</h4>
                  <span class="catname">Bathroom Plumbing</span>
                  <span class="catslug"> ( plumbing-service ) </span>
                </div>
              </div>
            </div>
          </div>
        ...
        <a href="http://profesionales5estrellas.com/" class="fancybox">
        <div class="col-lg-4 col-sm-6 col-xs-12 plumbing-service  bathroom-plumbing broken-toilets drane-cloge kitchen-plumbing outside-plumbing single-project-item mix">
          <div class="img-wrap">
            <img src="http://profesionales5estrellas.com/" alt="">
            <div class="content-wrap hvr-rectangle-out">
              <div class="border">
        ...
        </a></div></div></section></div></div></div></div><div class="vc_row-full-width vc_clearfix"></div><div data-vc-full-width="true" data-vc-full-width-init="true" data-vc-stretch-content="true" class="vc_row wpb_row vc_row-fluid vc_row-no-padding" style="position: relative; left: -74.5px; box-sizing: border-box; width: 1349px;"><div class="wpb_column vc_column_container vc_col-sm-12"><div class="vc_column-inner"><div class="wpb_wrapper"><section id="our-specialist" class="" style="background:"><div class="container">
      <div class="section-title">
  ...
  <div class="col-lg-3 col-md-3 col-sm-6 wow zoomIn hvr-float-shadow" data-wow-duration=".5s" data-wow-delay="0">
    ...
    </div></div></section></div></div></div></div><div class="vc_row-full-width vc_clearfix"></div><div data-vc-full-width="true" data-vc-full-width-init="true" data-vc-stretch-content="true" class="vc_row wpb_row vc_row-fluid vc_row-no-padding" style="position: relative; left: -74.5px; box-sizing: border-box; width: 1349px;"><div class="wpb_column vc_column_container vc_col-sm-12"><div class="vc_column-inner"><div class="wpb_wrapper">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-offset-3 col-md-offset-3 col-lg-9 col-md-9">
          ...
          <p class="phone-contact"><b>+34 610341742</b> O <a href="http://profesionales5estrellas.com/contactenos/" class="hvr-bounce-to-right">Contáctenos</a></p>
        </div>
      </div>
    </div>
  </section></div></div></div></div><div class="vc_row-full-width vc_clearfix"></div><div class="vc_row wpb_row vc_row-fluid"><div class="wpb_column vc_column_container vc_col-sm-12"><div class="vc_column-inner vc_custom_1459440174592"><div class="wpb_wrapper"><section id="clients">
...
<div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-1180px, 0px, 0px); transition: all 0s ease 0s; width: 3540px;"><div class="owl-item cloned" style="width: auto; margin-right: 40px;"><div class="item">
                  <img src="./Inicio - Profesionales5estrellas_files/g948.png" alt="">
                </div></div><div class="owl-item cloned" style="width: auto; margin-right: 40px;"><div class="item">
                  <img src="./Inicio - Profesionales5estrellas_files/g948.png" alt="">
                </div></div><div class="owl-item cloned" style="width: auto; margin-right: 40px;"><div class="item">
                  <img src="./Inicio - Profesionales5estrellas_files/g948.png" alt="">
                </div></div><div class="owl-item cloned" style="width: auto; margin-right: 40px;"><div class="item">
                  ...
                  <img src="./Inicio - Profesionales5estrellas_files/g948.png" alt="" style="opacity: 1;">
                </div></div><div class="owl-item active" style="width: auto; margin-right: 40px;"><div class="item">
                  <img src="./Inicio - Profesionales5estrellas_files/g948.png" alt="">
                </div></div><div class="owl-item active" style="width: auto; margin-right: 40px;"><div class="item">
                  <img src="./Inicio - Profesionales5estrellas_files/g948.png" alt="">
                </div></div><div class="owl-item active" style="width: auto; margin-right: 40px;"><div class="item">
          ...
          <div class="owl-controls"><div class="owl-nav"><div class="owl-prev" style=""><i class="fa fa-angle-left"></i>
          </div>
          <div class="owl-next" style=""><i class="fa fa-angle-right"></i>
          </div>
        </div>
